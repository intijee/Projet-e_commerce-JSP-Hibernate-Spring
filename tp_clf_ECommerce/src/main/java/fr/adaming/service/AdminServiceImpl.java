...
/**
 * Classe qui sert à implementer les règles de gestion pour les méthodes de
 * l'Admin
 *
 */
...
public class AdminServiceImpl implements IAdminService {
	...
	// Instanciation d'un objet de type AdminDao pour utliser ses méthodes à
	...
	public int modifierRoleService(Admin admin, Role role) {
		// il pourrait être judicieux de n'accepter en role que ROLE_ADMIN_CAT
		// et ROLE_ADMIN_PROD
		try {
	...
	public Produit getProduitByIdService(int id_produit) {
		...
		return adminDao.getProduitById(id_produit);
	}
