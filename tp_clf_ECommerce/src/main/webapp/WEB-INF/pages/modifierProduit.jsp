...
<body background='<c:url value="/resources/fonecran.jpg"/>'>
	...
	<div
		...
		<form:form method="POST" action="soumettreFormModifierProduit"
			modelAttribute="modifierFormProduit">
			...
			<tr>
				...
				<tr>
					<td><form:label path="designation" cssStyle="color:white">Designation</form:label></td>
